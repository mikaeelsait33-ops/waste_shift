...
assert.match(setupWizardSource, /onPrepareManagerAccess/);
assert.match(setupWizardSource, /managerPin: progress\.managerPin/);
assert.doesNotMatch(setupWizardSource, /JSON\.stringify\(\{\s*\.\.\.progress/);
assert.doesNotMatch(setupWizardSource, /localStorage|sessionStorage|indexedDB/);
...
assert.match(firestoreSource, /stripStaffCredentials/);
