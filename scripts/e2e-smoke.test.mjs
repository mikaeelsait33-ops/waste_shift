...
const geminiMenuImport = await read('../src/services/geminiMenuImport.js');
...
assert.match(menuImportPanel, /requestGeminiMenuImport/);
assert.match(menuImport, /requestGeminiMenuImport/);
...
assert.match(geminiMenuImport, /getAutomaticManagerApiHeaders/);
assert.match(geminiMenuImport, /getManagerApiErrorMessage/);
assert.match(geminiMenuImport, /AbortController/);
...
assert.match(invoiceScanner, /parseInvoiceCsvText/);
assert.match(invoiceScanner, /priceExVAT: unitPriceExVAT/);
