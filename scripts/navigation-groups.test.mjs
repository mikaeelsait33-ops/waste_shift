...
assert.match(navbar, /key: 'inventory', label: 'Invoices'/, 'Navigation should expose one Invoices tab.');
assert.match(navbar, /key: 'menuPricing', label: 'Menu'/, 'Navigation should expose one Menu tab.');
...
assert.match(invoiceScanner, /New invoice/, 'The invoice workspace should include a new-invoice flow.');
assert.match(invoiceScanner, /setActiveView\('ingredients'\)/, 'The invoice workspace should include raw ingredients.');
assert.match(invoiceScanner, /setActiveView\('history'\)/, 'The invoice workspace should include processed invoices.');
